...
public class ShoppingCartSpringBootAppApplication {
	...
	CommandLineRunner runner(ProductService productService) {
		return args -> {
			...
			productService.save(new Product(8L, "Shoe", 15.00, "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTiH_zybxAk5-cCTYgodJttedRv7Y_V5Gb2qX2OqOfWIlWZQfC5"));
			productService.save(new Product(9L, "Clock", 50.00, "https://cdn.shopify.com/s/files/1/1256/7113/products/04June2019-CliMET-6_600.jpg?v=1560163205"));
		};
	}
}
